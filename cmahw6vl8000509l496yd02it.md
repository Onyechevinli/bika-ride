...
**Step 3: Create a Resource group and Virtual Machine In Azure -** Create a VM in azure refer to the link below on how to create a Vm; [**https://ladyintech.hashnode.dev/a-beginners-guide-to-creating-a-windows-11-pro-virtual-machine-in-azure**](https://ladyintech.hashnode.dev/a-beginners-guide-to-creating-a-windows-11-pro-virtual-machine-in-azure) - Create a new resource group and other resources
...
**Step 4: Open VS-Code and Create Folder -** Click on "**File"** from the dropdown Select **"Open Folder"**
